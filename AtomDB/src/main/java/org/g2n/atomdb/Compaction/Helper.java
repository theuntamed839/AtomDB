...
import static org.g2n.atomdb.util.Util.fileSeparatorForSplit;
...
public class Helper implements Comparable<Helper>, Iterator<Map.Entry<byte[], ValueUnit>>, AutoCloseable {
    ...
    public Helper(String file) throws Exception {
        ...
        System.out.printf("helper fileToWrite="+file);
        // fileToWrite rank and level
        ...
        this.fileRankInLevel = Long.parseLong(pieces[1].replace(".org.g2n.atomdb.sst", ""));

        this.header = null; //Header.getHeader(fileToWrite, channel, byteBuffer);
