...
public class DBImpl implements DB{
    ...
    public DBImpl(File dbFolder, DBOptions dbOptions) throws Exception {
        ...
        // restoring the log memtable data.
        System.out.println("restore dbimpl");
    ...
    public void put(byte[] key, byte[] value) throws Exception {
        ...
        walManager.log(Operations.WRITE, key, value);
        System.out.println("inserted" + new String(key) + "->" + new String(value));
    ...
    public byte[] delete(byte[] key) throws Exception {
        walManager.log(Operations.DELETE, key,null);
